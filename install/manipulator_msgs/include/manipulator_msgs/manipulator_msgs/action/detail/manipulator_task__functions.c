...
manipulator_msgs__action__ManipulatorTask_Goal__create(void)
{
  ...
  manipulator_msgs__action__ManipulatorTask_Goal * msg = (manipulator_msgs__action__ManipulatorTask_Goal *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_Goal));
  bool success = manipulator_msgs__action__ManipulatorTask_Goal__init(msg);
  if (!success) {
...
manipulator_msgs__action__ManipulatorTask_Goal__destroy(manipulator_msgs__action__ManipulatorTask_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    manipulator_msgs__action__ManipulatorTask_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_Goal__Sequence__init(manipulator_msgs__action__ManipulatorTask_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Goal * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_Goal *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_Goal__fini(&data[i - 1]);
      }
...
manipulator_msgs__action__ManipulatorTask_Goal__Sequence__fini(manipulator_msgs__action__ManipulatorTask_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Goal__Sequence * array = (manipulator_msgs__action__ManipulatorTask_Goal__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_Goal__Sequence__init(array, size);
  if (!success) {
...
manipulator_msgs__action__ManipulatorTask_Goal__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_Goal__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_Goal__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_Goal * data =
      (manipulator_msgs__action__ManipulatorTask_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Result * msg = (manipulator_msgs__action__ManipulatorTask_Result *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_Result));
  bool success = manipulator_msgs__action__ManipulatorTask_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_Result__destroy(manipulator_msgs__action__ManipulatorTask_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    manipulator_msgs__action__ManipulatorTask_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_Result__Sequence__init(manipulator_msgs__action__ManipulatorTask_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Result * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_Result *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_Result__Sequence__fini(manipulator_msgs__action__ManipulatorTask_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Result__Sequence * array = (manipulator_msgs__action__ManipulatorTask_Result__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_Result__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_Result__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_Result__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_Result * data =
      (manipulator_msgs__action__ManipulatorTask_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Feedback * msg = (manipulator_msgs__action__ManipulatorTask_Feedback *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_Feedback));
  bool success = manipulator_msgs__action__ManipulatorTask_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_Feedback__destroy(manipulator_msgs__action__ManipulatorTask_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    manipulator_msgs__action__ManipulatorTask_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_Feedback__Sequence__init(manipulator_msgs__action__ManipulatorTask_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Feedback * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_Feedback *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_Feedback__Sequence__fini(manipulator_msgs__action__ManipulatorTask_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_Feedback__Sequence * array = (manipulator_msgs__action__ManipulatorTask_Feedback__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_Feedback__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_Feedback__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_Feedback__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_Feedback * data =
      (manipulator_msgs__action__ManipulatorTask_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Request__init(manipulator_msgs__action__ManipulatorTask_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!manipulator_msgs__action__ManipulatorTask_Goal__init(&msg->goal)) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Request__fini(manipulator_msgs__action__ManipulatorTask_SendGoal_Request * msg)
{
  ...
  // goal
  manipulator_msgs__action__ManipulatorTask_Goal__fini(&msg->goal);
}
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Request__are_equal(const manipulator_msgs__action__ManipulatorTask_SendGoal_Request * lhs, const manipulator_msgs__action__ManipulatorTask_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!manipulator_msgs__action__ManipulatorTask_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Request * msg = (manipulator_msgs__action__ManipulatorTask_SendGoal_Request *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Request));
  bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__init(manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Request * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_SendGoal_Request *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__fini(manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence * array = (manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_SendGoal_Request * data =
      (manipulator_msgs__action__ManipulatorTask_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Response__init(manipulator_msgs__action__ManipulatorTask_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Response * msg = (manipulator_msgs__action__ManipulatorTask_SendGoal_Response *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Response));
  bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__init(manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Response * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_SendGoal_Response *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__fini(manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence * array = (manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_SendGoal_Response * data =
      (manipulator_msgs__action__ManipulatorTask_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Event__init(manipulator_msgs__action__ManipulatorTask_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Event__fini(manipulator_msgs__action__ManipulatorTask_SendGoal_Event * msg)
{
  ...
  // request
  manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__fini(&msg->response);
}
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Event__are_equal(const manipulator_msgs__action__ManipulatorTask_SendGoal_Event * lhs, const manipulator_msgs__action__ManipulatorTask_SendGoal_Event * rhs)
{
  ...
  // request
  if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__are_equal(
  ...
  manipulator_msgs__action__ManipulatorTask_SendGoal_Event * output)
{
  ...
  // request
  if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Event * msg = (manipulator_msgs__action__ManipulatorTask_SendGoal_Event *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Event));
  bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence__init(manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Event * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_SendGoal_Event *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence__fini(manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence * array = (manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_SendGoal_Event * data =
      (manipulator_msgs__action__ManipulatorTask_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Request__init(manipulator_msgs__action__ManipulatorTask_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Request * msg = (manipulator_msgs__action__ManipulatorTask_GetResult_Request *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Request));
  bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__init(manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Request * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_GetResult_Request *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__fini(manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence * array = (manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_GetResult_Request * data =
      (manipulator_msgs__action__ManipulatorTask_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Response__init(manipulator_msgs__action__ManipulatorTask_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!manipulator_msgs__action__ManipulatorTask_Result__init(&msg->result)) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
manipulator_msgs__action__ManipulatorTask_GetResult_Response__fini(manipulator_msgs__action__ManipulatorTask_GetResult_Response * msg)
{
  ...
  // status
  // result
  manipulator_msgs__action__ManipulatorTask_Result__fini(&msg->result);
}
...
manipulator_msgs__action__ManipulatorTask_GetResult_Response__are_equal(const manipulator_msgs__action__ManipulatorTask_GetResult_Response * lhs, const manipulator_msgs__action__ManipulatorTask_GetResult_Response * rhs)
{
  ...
  // result
  if (!manipulator_msgs__action__ManipulatorTask_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Response * msg = (manipulator_msgs__action__ManipulatorTask_GetResult_Response *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Response));
  bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__init(manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Response * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_GetResult_Response *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__fini(manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence * array = (manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_GetResult_Response * data =
      (manipulator_msgs__action__ManipulatorTask_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Event__init(manipulator_msgs__action__ManipulatorTask_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__init(&msg->request, 0)) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__init(&msg->response, 0)) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
manipulator_msgs__action__ManipulatorTask_GetResult_Event__fini(manipulator_msgs__action__ManipulatorTask_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__fini(&msg->request);
  // response
  manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__fini(&msg->response);
}
...
manipulator_msgs__action__ManipulatorTask_GetResult_Event__are_equal(const manipulator_msgs__action__ManipulatorTask_GetResult_Event * lhs, const manipulator_msgs__action__ManipulatorTask_GetResult_Event * rhs)
{
  ...
  // request
  if (!manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  manipulator_msgs__action__ManipulatorTask_GetResult_Event * output)
{
  ...
  // request
  if (!manipulator_msgs__action__ManipulatorTask_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!manipulator_msgs__action__ManipulatorTask_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Event * msg = (manipulator_msgs__action__ManipulatorTask_GetResult_Event *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Event));
  bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence__init(manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Event * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_GetResult_Event *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence__fini(manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence * array = (manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_GetResult_Event * data =
      (manipulator_msgs__action__ManipulatorTask_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_FeedbackMessage__init(manipulator_msgs__action__ManipulatorTask_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    manipulator_msgs__action__ManipulatorTask_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!manipulator_msgs__action__ManipulatorTask_Feedback__init(&msg->feedback)) {
    manipulator_msgs__action__ManipulatorTask_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
manipulator_msgs__action__ManipulatorTask_FeedbackMessage__fini(manipulator_msgs__action__ManipulatorTask_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  manipulator_msgs__action__ManipulatorTask_Feedback__fini(&msg->feedback);
}
...
manipulator_msgs__action__ManipulatorTask_FeedbackMessage__are_equal(const manipulator_msgs__action__ManipulatorTask_FeedbackMessage * lhs, const manipulator_msgs__action__ManipulatorTask_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!manipulator_msgs__action__ManipulatorTask_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_FeedbackMessage * msg = (manipulator_msgs__action__ManipulatorTask_FeedbackMessage *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulator_msgs__action__ManipulatorTask_FeedbackMessage));
  bool success = manipulator_msgs__action__ManipulatorTask_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence__init(manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_FeedbackMessage * data = NULL;

  if (size) {
    data = (manipulator_msgs__action__ManipulatorTask_FeedbackMessage *)allocator.zero_allocate(size, sizeof(manipulator_msgs__action__ManipulatorTask_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulator_msgs__action__ManipulatorTask_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulator_msgs__action__ManipulatorTask_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence__fini(manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulator_msgs__action__ManipulatorTask_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence * array = (manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence *)allocator.allocate(sizeof(manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence__destroy(manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence__are_equal(const manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence * lhs, const manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulator_msgs__action__ManipulatorTask_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulator_msgs__action__ManipulatorTask_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulator_msgs__action__ManipulatorTask_FeedbackMessage * data =
      (manipulator_msgs__action__ManipulatorTask_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulator_msgs__action__ManipulatorTask_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulator_msgs__action__ManipulatorTask_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulator_msgs__action__ManipulatorTask_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
